...
from core.models import Conversation, FeatureKey, FeaturePreset
from core.services.base import BaseConversationService
...
class ChatService(BaseConversationService):
    ...
    async def create_conversation_with_default_preset(
        ...
        # Store user_id both in the database field and feature_params for backward compatibility
